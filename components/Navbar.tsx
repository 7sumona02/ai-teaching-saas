...
export const Navbar = () => {
    ...
    return (
        <header className="sticky h-14 inset-x-0 top-2 z-30 w-full">
            <nav
                data-state={menuState && 'active'}
                >
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 md:px-5', isScrolled && 'bg-background/50 max-w-6xl rounded-2xl border backdrop-blur-lg md:px-12')}>
